...
function RoundToPixel(const Source: TRectF; const AThickness: Single = 1)
  : TRectF; overload;
function RoundToPixel(const Source: TPointF; const AThickness: Single = 1)
  : TPointF; overload;
function RoundToPixel(const Source: Single; const AThickness: Single = 1)
  : Single; overload;
...
uses
  System.Math, System.SysUtils, FMX.Forms, FMX.Platform, FGX.Helpers,
  FGX.Consts,
...
begin
  Result := Source;
  if SameValue(Round(Source * Screen.Scale), Source * Screen.Scale,
    Single.Epsilon) then
