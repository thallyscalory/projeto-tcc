...
type
  TDM = class(TDataModule)
    ...
    FDQFornEditContaPagar: TFDQuery;
    FDQFornEditContaPagarid: TFDAutoIncField;
    FDQFornEditContaPagartipo_pessoa: TStringField;
    FDQFornEditContaPagarnome: TStringField;
    FDQFornEditContaPagarnome_fantasia: TStringField;
    FDQFornEditContaPagarcpf_cnpj: TStringField;
    FDQFornEditContaPagarrg_ie: TStringField;
    FDQFornEditContaPagarfone: TStringField;
    FDQFornEditContaPagarendereco: TStringField;
    FDQFornEditContaPagarnumero: TStringField;
    FDQFornEditContaPagarcomplemento: TStringField;
    FDQFornEditContaPagarbairro: TStringField;
    FDQFornEditContaPagarcep: TStringField;
    FDQFornEditContaPagarcidade: TStringField;
    FDQFornEditContaPagaruf: TStringField;
    FDQFornEditContaPagaremail: TStringField;
    FDQFornEditContaPagarobs: TWideMemoField;
    FDQFornEditContaPagarstatus: TStringField;
    FDQFornEditContaPagardata_cad: TDateField;
    FDQDespesaEditContaPagar: TFDQuery;
    FDQDespesaEditContaPagarid: TFDAutoIncField;
    FDQDespesaEditContaPagardescricao: TStringField;
    FDQConsContasPagarBaixa: TFDQuery;
    FDQConsContasPagarBaixaid: TFDAutoIncField;
    FDQConsContasPagarBaixaid_fornecedor: TIntegerField;
    FDQConsContasPagarBaixaid_tipo_despesa: TIntegerField;
    FDQConsContasPagarBaixan_doc: TStringField;
    FDQConsContasPagarBaixavalor_doc: TBCDField;
    FDQConsContasPagarBaixavalor_descmoeda: TBCDField;
    FDQConsContasPagarBaixavalor_acresc: TBCDField;
    FDQConsContasPagarBaixavalor_pago: TBCDField;
    FDQConsContasPagarBaixavalor_saldo: TBCDField;
    FDQConsContasPagarBaixadata_cad: TDateTimeField;
    FDQConsContasPagarBaixadata_venc: TDateField;
    FDQConsContasPagarBaixadata_quitacao: TDateTimeField;
    FDQConsContasPagarBaixaquitado: TStringField;
    FDQCadBaixaContaPagar: TFDQuery;
    FDQCadBaixaContaPagarid: TFDAutoIncField;
    FDQCadBaixaContaPagarid_conta_pagar: TIntegerField;
    FDQCadBaixaContaPagardata: TDateTimeField;
    FDQCadBaixaContaPagarvalor: TBCDField;
    ...
    FDQConsAtalhos: TFDQuery;
    FDQEditAtalhos: TFDQuery;
    FDQConsAtalhosid: TFDAutoIncField;
    FDQConsAtalhosnome: TStringField;
    FDQConsAtalhostag: TIntegerField;
    FDQConsAtalhosativo: TStringField;
    FDQEditAtalhosid: TFDAutoIncField;
    FDQEditAtalhosnome: TStringField;
    FDQEditAtalhostag: TIntegerField;
    FDQEditAtalhosativo: TStringField;
    FDQConsCaixa: TFDQuery;
    FDQEditCaixa: TFDQuery;
    FDQConsItemCaixa: TFDQuery;
    FDQEditItemCaixa: TFDQuery;
    FDQConsCaixaid: TFDAutoIncField;
    FDQConsCaixadataAbertura: TDateTimeField;
    FDQConsCaixadataFechamento: TDateTimeField;
    FDQConsCaixavlAbertura: TFloatField;
    FDQConsCaixavlRecebimento: TFloatField;
    FDQConsCaixavlRetirada: TFloatField;
    FDQConsCaixavlSaldo: TFloatField;
    FDQConsCaixaidFuncionario: TIntegerField;
    FDQConsCaixaaberto: TStringField;
    FDQEditCaixaid: TFDAutoIncField;
    FDQEditCaixadataAbertura: TDateTimeField;
    FDQEditCaixadataFechamento: TDateTimeField;
    FDQEditCaixavlAbertura: TFloatField;
    FDQEditCaixavlRecebimento: TFloatField;
    FDQEditCaixavlRetirada: TFloatField;
    FDQEditCaixavlSaldo: TFloatField;
    FDQEditCaixaidFuncionario: TIntegerField;
    FDQEditCaixaaberto: TStringField;
    FDQConsItemCaixaid: TFDAutoIncField;
    FDQConsItemCaixaidCaixa: TIntegerField;
    FDQConsItemCaixadataLancamento: TDateTimeField;
    FDQConsItemCaixavlLancamento: TFloatField;
    FDQConsItemCaixadescricaoLancamento: TStringField;
    FDQConsItemCaixatipoLancamento: TStringField;
    FDQEditItemCaixaid: TFDAutoIncField;
    FDQEditItemCaixaidCaixa: TIntegerField;
    FDQEditItemCaixadataLancamento: TDateTimeField;
    FDQEditItemCaixavlLancamento: TFloatField;
    FDQEditItemCaixadescricaoLancamento: TStringField;
    FDQEditItemCaixatipoLancamento: TStringField;
    FDQCadPedidoidCaixa: TIntegerField;
    FDQCadItemPedidoidCaixa: TIntegerField;
    ...
    FDQConsContasReceberidCaixa: TIntegerField;
    ...
    FDQCadContasReceberidCaixa: TIntegerField;
    FDQConsContasReceberBaixaidCaixa: TIntegerField;
    FDQCadBaixaContasReceberidcaixa: TIntegerField;
    ...
    FDQConsContaPagaridCaixa: TIntegerField;
    ...
    FDQCadContaPagaridCaixa: TIntegerField;
    FDQConsContasPagarBaixaidCaixa: TIntegerField;
    FDQCadBaixaContaPagaridCaixa: TIntegerField;
    FDQFormaPagCaixa: TFDQuery;
    FDQFormaPagCaixaid_forma_pag: TFDAutoIncField;
    FDQFormaPagCaixadescricao_forma_pag: TStringField;
    FDQFormaPagCaixageraconta_forma_pag: TStringField;
    FDQFormaPagCaixaavista_forma_pag: TStringField;
    FDQFormaPagCaixacondicional_forma_pag: TStringField;
    FDQFormaPagCaixastatus: TStringField;
    FDQFormaPagCaixadataCad: TDateTimeField;
    FDQFormaPagCaixaentraCaixa: TStringField;
    FDQContaReceberItemCaixa: TFDQuery;
    FDQContaReceberItemCaixaid: TFDAutoIncField;
    FDQContaReceberItemCaixaid_pedido: TIntegerField;
    FDQContaReceberItemCaixaid_cliente: TIntegerField;
    FDQContaReceberItemCaixaid_forma_pag: TIntegerField;
    FDQContaReceberItemCaixavalor_documento: TBCDField;
    FDQContaReceberItemCaixavalor_juro: TBCDField;
    FDQContaReceberItemCaixavalor_desconto: TBCDField;
    FDQContaReceberItemCaixavalor_pago: TBCDField;
    FDQContaReceberItemCaixavalor_saldo: TBCDField;
    FDQContaReceberItemCaixadata_venc: TDateField;
    FDQContaReceberItemCaixadata_cad: TDateField;
    FDQContaReceberItemCaixadata_quitacao: TDateField;
    FDQContaReceberItemCaixaquitado: TStringField;
    FDQContaReceberItemCaixaidCaixa: TIntegerField;
    FDQConsFormaPagentraCaixa: TStringField;
    FDQCadFormaPagstatus: TStringField;
    FDQCadFormaPagdataCad: TDateTimeField;
    FDQCadFormaPagentraCaixa: TStringField;
    FDQConsAvistaFormaPagentraCaixa: TStringField;
    FDQContaPagarItemCaixa: TFDQuery;
    FDQContaPagarItemCaixaid: TFDAutoIncField;
    FDQContaPagarItemCaixaid_fornecedor: TIntegerField;
    FDQContaPagarItemCaixaid_tipo_despesa: TIntegerField;
    FDQContaPagarItemCaixan_doc: TStringField;
    FDQContaPagarItemCaixavalor_doc: TBCDField;
    FDQContaPagarItemCaixavalor_descmoeda: TBCDField;
    FDQContaPagarItemCaixavalor_acresc: TBCDField;
    FDQContaPagarItemCaixavalor_pago: TBCDField;
    FDQContaPagarItemCaixavalor_saldo: TBCDField;
    FDQContaPagarItemCaixadata_cad: TDateTimeField;
    FDQContaPagarItemCaixadata_venc: TDateField;
    FDQContaPagarItemCaixadata_quitacao: TDateTimeField;
    FDQContaPagarItemCaixaquitado: TStringField;
    FDQContaPagarItemCaixaidCaixa: TIntegerField;
    FDQConsFormaPagpagar: TStringField;
    FDQConsFormaPagreceber: TStringField;
    FDQCadFormaPagpagar: TStringField;
    FDQCadFormaPagreceber: TStringField;
    FDQConsAvistaFormaPagpagar: TStringField;
